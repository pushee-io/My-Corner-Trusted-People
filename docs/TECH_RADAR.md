...
| EAS CLI | `21.4.0` | Stable npm release | https://github.com/expo/eas-cli/releases | 2026-08-02 | Internal preview builds | Current stable version verified through npm and pinned in `mobile/eas.json` | Cloud builds may consume account quota or incur plan charges | Upgrade deliberately after Expo compatibility and preview-build verification |
