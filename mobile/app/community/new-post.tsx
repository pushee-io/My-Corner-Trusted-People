...
export default function NewLocalPostScreen() {
  ...
  return (
    <Screen title="Create local post">
      ...
      <TextInput value={body} onChangeText={setBody} multiline style={styles.textArea} accessibilityLabel="Post details" />
...
const styles = StyleSheet.create({
  ...
  input: { minHeight: tokens.touch.min, backgroundColor: tokens.color.surface, borderColor: tokens.color.border, borderWidth: 1, borderRadius: tokens.radius.md, padding: tokens.spacing.lg },
  textArea: { minHeight: 128, backgroundColor: tokens.color.surface, borderColor: tokens.color.border, borderWidth: 1, borderRadius: tokens.radius.md, padding: tokens.spacing.lg, textAlignVertical: 'top' },
  button: { minHeight: tokens.touch.min, justifyContent: 'center', backgroundColor: tokens.color.primary, borderRadius: tokens.radius.md, padding: tokens.spacing.lg },
